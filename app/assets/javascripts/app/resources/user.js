angular.module('todo-list.resources').factory('UserSession', ['$http', function($http) {
...
//
angular.module('todo-list.resources').factory('UserRegistration', ['$http', function($http) {
